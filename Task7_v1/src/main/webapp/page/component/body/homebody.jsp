...
<main>
    ...
    <div class="container ct1">
        <div class="row advantage">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                <div class="count">
                    <p><a class="glyphicon glyphicon-user"> ${allCount} </a><a class="f3">累计在线学习人数</a></p>
                    <p><a class="glyphicon glyphicon-user"> ${workSize}</a><a class="f3">学员已经找到满意工作</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="show">
        ...
        <div class="container showone">
            ...
            <c:forEach var="stu" items="${listBean}" varStatus="status">

                <div class="col-md-6 col-lg-3 col-xs-12">
                    <div class="students">
                        <img class="img-circle" src="img/Avatar${status.index}.png">
                        <span class="title">法号：${stu.p_Name}</span>
                        <div>
                            <p>毕业院校：${stu.p_graduation}<br/>
                                信念：${stu.p_oath}<br/>
                                加入时间：
                                <jsp:setProperty name="date" property="time" value="${stu.p_createTime}"/>
