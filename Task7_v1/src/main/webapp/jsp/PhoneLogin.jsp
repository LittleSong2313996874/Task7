...
<div class="content">
    <form role="form" action="${contextpath}/verify/phone" method="post" id="sub">
        ...
        <div class="form-group">
            ...
            &#12288;&#12288;&#12288;&#12288;&#12288;&#12288;
            <input type="submit" class="btn btn-default" id="verify" style="margin-top:50px" onclick="verify()" value="登录">
        ...
        if(!myreg.test(phone))
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var msg = data.msg_phone_login;
                    $(".alert2").html("<font color='white'><b>"+msg+"</b></font>");
                    var code = data.code;
                    if (code == "ok") {
